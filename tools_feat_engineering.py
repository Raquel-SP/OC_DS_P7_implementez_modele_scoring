...
class feat_eng_application_train_test:
    ...
    def __init__(self, file_directory = '', verbose = True, dump_to_pickle = False):
        ...
        self.path_sav_appltrain_wonan = '/home/raquelsp/Documents/Openclassrooms/P7_implementez_modele_scoring/P7_travail/P7_scoring_credit/preprocessing/application_train_wo_nan.pkl'
        self.path_sav_appltest_wonan = '/home/raquelsp/Documents/Openclassrooms/P7_implementez_modele_scoring/P7_travail/P7_scoring_credit/preprocessing/application_test_wo_nan.pkl'
    ...
    def numeric_feature_engineering(self, data):
        ...
        data['APARTMENTS_SUM_AVG'] = data['APARTMENTS_AVG'] + data['BASEMENTAREA_AVG'] + data['YEARS_BEGINEXPLUATATION_AVG'] + data[
                                    'YEARS_BUILD_AVG'] + data['ELEVATORS_AVG'] + data['ENTRANCES_AVG'] + data['FLOORSMAX_AVG'] + data['FLOORSMIN_AVG'] + data['LANDAREA_AVG'] + data[
...
class feat_eng_bureau:
    ...
    def feat_eng_bureau(self):
        '''
        Function to preprocess the bureau table and merge it with the result of feature engineering of bureau_balance table.
...
class feat_eng_installments_payments:
    ...
    def main(self):
        ...
        if self.dump_to_pickle:
            ...
            with open(self.file_directory + 'installments_payments_afteng.pkl', 'wb') as f:
...
# -----------------------------------------------------------------------------
# -- FUNTION TO CREATE FEATURES USING THE INTERACTIONS BETWEEN VARIOUS TABLES
# -----------------------------------------------------------------------------
...
def tracer_features_importance(dataframe, df_features_importance, jeu, methode):
    """
    Displays the step, then the number of lines and variables for the transmitted dataframe
    Parameters
    ----------
